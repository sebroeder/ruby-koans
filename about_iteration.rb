...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # It combines all elements of the Enumerable by applying the binary
    # operation in the the block (using an accumulator).
  end
  ...
  # The block construct automatically closes the file handle at the end of the
  # block. In the second alternative one has to do this manually with
  # `file.close` (and must not forget it).
