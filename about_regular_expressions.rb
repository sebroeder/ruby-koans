...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    #
    # Since * accepts the empty string, it will never fail to match.
  end
  ...
  # Why?
  #
  # They consume as much input as they can, not just the minimum input needed
  # to match the regex.
  ...
  #
  # Character classes only allow alternation between single characters,
  # where as the vertical pipe (|) allows alternation between whole strings.
